...
On a success, you create the meal with the relevant number of portions. On a failure, all ingredients are wasted, and the meal provides no additional effects and/or becomes inedible, scaling with the value of the roll.
...
## Learning Recipes
Recipes can be naturally discovered from others or if you find recipe books. When a recipe is made with guidance, you roll with Advantage when making the dish.

In addition, recipes may be procured through:
...
# Culinary Effects
In addition to the satiating effects that are typical of rations, some recipes provide additional buffs in respect to their taste and fulfillment.
